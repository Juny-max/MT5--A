...
void OnTick()
{
    ...
    datetime expirationDate = D'2026.04.01 00:00:00';
    if(TimeCurrent() >= expirationDate)
    {
        static bool expirationAlertShown = false;
        if(!expirationAlertShown)
        {
            Print("TRIAL EXPIRED. Please renew your subscription.");
            Alert("Access Denied. Contact support: junyappteam@gmail.com");
